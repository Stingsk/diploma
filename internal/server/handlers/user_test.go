...
func TestUserHandlers(t *testing.T) {
	testRegister := []testUser{
		{
			...
			want: want{
				code: http.StatusOK,
				data: "Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJsb2dpbiI6InRlc3QifQ.pV-CiPiB0QjqUno0SPHOlO4NWx_Gd0vHMrtRIjUqdhQ",
			},
		},
		{
	...
	RegisterPublicHandlers(mux, users.NewInMemoryStore(), jwtToken)
